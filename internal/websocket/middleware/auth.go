...
func AuthenticateWebSocket(ctx context.Context, token, jwtSecret, issuer string) (string, error) {
	if token == "" {
...
func ValidateToken(token, jwtSecret, issuer string) (string, error) {
	if token == "" {
